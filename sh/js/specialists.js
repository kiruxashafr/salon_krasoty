...
function showBookingSuccessSpecialist() {
    ...
    fetch('/api/links')
                ...
                stepContent.innerHTML = `
                    <div class="booking-success">
                        ...
                        <div class="success-buttons">
                            ...
                            <button class="close-success-btn" onclick="closeSpecialistModalAndReload()">Закрыть</button>
                        </div>
                    </div>
                `;
        ...
        .catch(error => {
            ...
            showDefaultSuccessSpecialist();
        });
}

function closeSpecialistModalAndReload() {
    console.log('Closing specialist modal and reloading page');
    document.getElementById('specialist-modal').style.display = 'none';
